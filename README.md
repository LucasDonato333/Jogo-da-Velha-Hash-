...
<details><summary>
 ...
 Nada mais é que o layout do tabuleiro de Jogo da Velha. Ele será impresso como uma matriz. 
</details>
...
#### Funções
<details><summary>
 - remove_possibilidades(numero)</summary>
...
<hr>
<details><summary>
- verifica_possibilidades(n) </summary>
...
if ["O","O","O"] in ganhar:
        ...
        fim_de_jogo()
```
_Trecho completo do código citado a cima._
</details>
...
**exibe()** é a função responsável por exibir a matriz. Sempre que chamada ela apresenta na tela os valores que estão na lista **tabuleiro**.
</details>
